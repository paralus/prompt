...
![Go Report Card](https://goreportcard.com/badge/github.com/RafaySystems/rafay-prompt)

An interactive kubernetes client featuring auto-complete using [go-prompt](https://github.com/RafaySystems/rafay-prompt/pkg/prompt).
...
Binaries are available from [github release](https://github.com/RafaySystems/rafay-prompt/releases).

<details>
<summary>macOS (darwin) - amd64</summary>

```
wget https://github.com/RafaySystems/rafay-prompt/releases/download/v1.0.10/kube-prompt_v1.0.10_darwin_amd64.zip
...
```
wget https://github.com/RafaySystems/rafay-prompt/releases/download/v1.0.10/kube-prompt_v1.0.10_linux_amd64.zip
...
```
wget https://github.com/RafaySystems/rafay-prompt/releases/download/v1.0.10/kube-prompt_v1.0.10_linux_386.zip
...
```
wget https://github.com/RafaySystems/rafay-prompt/releases/download/v1.0.10/kube-prompt_v1.0.10_linux_arm64.zip
